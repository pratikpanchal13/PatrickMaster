...
class FWUtilityDrawer
{
    ...
    func loginToDrawerFrom(_ controller : UIViewController,animated: Bool){
        ...
        let mainStoryboard = UIStoryboard(storyboard:.SideMenu)

//        let mainStoryboard :UIStoryboard = UIStoryboard(name: "SideMenu", bundle: nil)
        let storyboard = UIStoryboard(storyboard:.Messages)

        let centerViewController = storyboard.instantiateViewController(withIdentifier: "PKMessageVC") as! PKMessageVC
